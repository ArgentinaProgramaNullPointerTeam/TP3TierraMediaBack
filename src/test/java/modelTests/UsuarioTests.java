...
public class UsuarioTests {
	...
	public void setup() {
		...
		u1 = new Usuario(2, "pepito", "Aventura", 100, 100, 0, 1);

		a1 = new Atraccion(1, "a1", 10, 3, 20, "Aventura", 1);
		a2 = new Atraccion(2, "a2", 4, 2.5, 20, "Aventura", 1);
		a3 = new Atraccion(3, "a3", 2, 1, 20, "Aventura", 1);
		a4 = new Atraccion(4, "a4", 8, 4, 20, "Aventura", 1);
		...
		packCuatro.add(a2);
		packCuatro.add(a4);
		p4 = new PromocionAbsoluta(4, "Pack Cuatro", 2, packCuatro, "Absoluta", 5, 1);
	}
	...
	public void comprarTestDinero() {
		...
		Producto sugerenciaAceptada = new Atraccion(5, "Rivendel", 20, 1.5, 2, "Aventura", 1);
