...
public class PromocionAXBTest {
	...
	public void setup() {
		...
		atraccion2 = new Atraccion(2, "Hobbiton", 40, 3.5, 8, "Aventura", 1);
		atraccion3 = new Atraccion(3, "Edoras", 60, 0.5, 9, "Aventura", 1);

		pack.add(atraccion1);
		pack.add(atraccion2);
		pack.add(atraccion3);

		promo = new PromocionAXB(1, "Pack 1", 3, pack, "AXB", 3, 1);
	}
